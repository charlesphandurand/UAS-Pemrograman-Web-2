...
@section('konten')
    <div class="container" style="margin-top: 70px; margin-bottom: 30px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8" style="width: 100%;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted">Platform: <a
                                                        class="text-decoration-none"
                                                        href="{{ route('sub-platform', $game->platform->platform_name) }}">{{ $game->platform->platform_name }}</a>
                                                </h6>
                                                <p class="card-text">
        ...
        @else
            <p class="text-center fs-3 fw-bold text-danger">There's no content for this platform. 😔</p>
        @endif
    </div>
@endsection
